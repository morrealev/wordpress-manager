...
export const gscHandlers: Record<string, Function> = {
  gsc_list_sites: async (_params: z.infer<typeof gscListSitesSchema>) => {
    if (!hasGSC()) {
  ...
  gsc_search_analytics: async (params: z.infer<typeof gscSearchAnalyticsSchema>) => {
    if (!hasGSC()) {
      return { toolResult: { isError: true, content: [{ type: "text", text: "GSC not configured. Add gsc_service_account_key and gsc_site_url to WP_SITES_CONFIG." }] } };
    }
    try {
      ...
      if (dimension_filter_groups) requestBody.dimensionFilterGroups = dimension_filter_groups;
  ...
  gsc_inspect_url: async (params: z.infer<typeof gscInspectUrlSchema>) => {
    if (!hasGSC()) {
      return { toolResult: { isError: true, content: [{ type: "text", text: "GSC not configured. Add gsc_service_account_key and gsc_site_url to WP_SITES_CONFIG." }] } };
    }
    try {
  ...
  gsc_list_sitemaps: async (_params: z.infer<typeof gscListSitemapsSchema>) => {
    if (!hasGSC()) {
      return { toolResult: { isError: true, content: [{ type: "text", text: "GSC not configured. Add gsc_service_account_key and gsc_site_url to WP_SITES_CONFIG." }] } };
    }
    try {
  ...
  gsc_submit_sitemap: async (params: z.infer<typeof gscSubmitSitemapSchema>) => {
    if (!hasGSC()) {
      return { toolResult: { isError: true, content: [{ type: "text", text: "GSC not configured. Add gsc_service_account_key and gsc_site_url to WP_SITES_CONFIG." }] } };
    }
    try {
  ...
  gsc_delete_sitemap: async (params: z.infer<typeof gscDeleteSitemapSchema>) => {
    if (!hasGSC()) {
      return { toolResult: { isError: true, content: [{ type: "text", text: "GSC not configured. Add gsc_service_account_key and gsc_site_url to WP_SITES_CONFIG." }] } };
    }
    try {
  ...
  gsc_top_queries: async (params: z.infer<typeof gscTopQueriesSchema>) => {
    if (!hasGSC()) {
      return { toolResult: { isError: true, content: [{ type: "text", text: "GSC not configured. Add gsc_service_account_key and gsc_site_url to WP_SITES_CONFIG." }] } };
    }
    try {
  ...
  gsc_page_performance: async (params: z.infer<typeof gscPagePerformanceSchema>) => {
    if (!hasGSC()) {
      return { toolResult: { isError: true, content: [{ type: "text", text: "GSC not configured. Add gsc_service_account_key and gsc_site_url to WP_SITES_CONFIG." }] } };
    }
    try {
